...
const PerformanceCard = ({ type, label, value }: PerformanceCardProps) => {
  ...
  return (
    <div className="group relative overflow-hidden rounded-xl bg-card border border-border p-6 sm:p-7 transition-all duration-300 hover:border-primary/40 hover:shadow-emerald min-h-[100px] sm:min-h-[110px]">
      ...
      <div className="relative flex items-center gap-4">
        <div className="flex-shrink-0 w-14 h-14 rounded-lg bg-primary/10 flex items-center justify-center group-hover:bg-primary/20 transition-colors duration-300">
